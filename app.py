...
st.title("Sentiment Analysis of Tweets of Top 10 MF")
...
select = st.sidebar.selectbox('Visualization type', ['Bar plot', 'Pie chart'], key='6')
...
each_airline = st.sidebar.selectbox('Visualization type', ['Bar plot', 'Pie chart'], key='7')
...
if not st.sidebar.checkbox("Close", True, key='22'):
